    ...
    return (
      <section className="py-8 px-8 text-center ">
        <h2 className="text-4xl sm:text-5xl font-extrabold mb-8   
                     bg-gradient-to-r from-cyan-400 via-pink-400 to-purple-500 bg-clip-text text-transparent drop-shadow-[0_0_12px_rgba(0,255,255,0.7)] text-center">Upcoming Concert</h2>
        <p>Loading images...</p>
      </section>
    );
  }

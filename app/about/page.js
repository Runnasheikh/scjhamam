  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white px-6 py-12 font-serif">
        ...
        {/* About */}
        <section className="mt-8 bg-gray-800/40 p-8 rounded-3xl shadow-lg backdrop-blur-md hover:scale-[1.01] transition">
        ...
        {/* Performances */}
        <section className="mt-6 bg-gray-800/40 p-8 rounded-3xl shadow-lg backdrop-blur-md">
          <h2 className="text-3xl font-semibold mb-4 border-b border-gray-600 pb-2">
            Notable Performances
          </h2>
          <ul className="list-disc list-inside space-y-2 text-gray-200">
  <li>Viddyapati Samaroh  Patna, Delhi, Kolkata, Ludhiana, Siliguri, Surat, Vadodra </li>
  <li>Mithila Sanskriti Vikas Samiti  Patna </li>
  <li>Viddyapati Smriti Parv Samaroh  Delhi </li>
  <li>NASVI Event  Jawahar Lal Nehru Stadium, Delhi</li>
  <li>Kamla Aarti  Bihar </li>
  <li>Janki Navmi  Delhi, Chandigarh </li>
